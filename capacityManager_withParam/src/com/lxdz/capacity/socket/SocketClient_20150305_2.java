 ...
 * 
 */
public class SocketClient_20150305_2 extends Service {
	
	public static BaseFragment currentPage;

	private static final String TAG = SocketClient_20150305_2.class.getSimpleName();
	...
	class Read implements Runnable  {
		...
		public void sendReceiveFinish(int type) {
			Intent intent = new Intent(SocketClient_20150305_2.ON_NEW_DATA);
	...
	public Handler wifiHandler = new Handler() {
		public void handleMessage(Message msg) {
			if (wifi == null)
				wifi = new WifiAdmin(SocketClient_20150305_2.this);
			switch (msg.what) {
			case WifiAdmin.EXIST_CONNECTED_WIFI:
				...
				if (wifi.getmWifiInfo() == null
					...
					if (scanWifi == null) {
						Toast.makeText(SocketClient_20150305_2.this, "扫描不到指定的WIFI",
		...
		public void onReceive(Context context, Intent intent) {
			if (intent.getAction()
				...
				case WifiManager.WIFI_STATE_DISABLING:
					Toast.makeText(SocketClient_20150305_2.this, "WIFI正在关闭",
							Toast.LENGTH_SHORT).show();
					closeIn();
					closeOut();
					closeSocket();
				...
				case WifiManager.WIFI_STATE_ENABLED:
					Toast.makeText(SocketClient_20150305_2.this, "WIFI打开成功",
							Toast.LENGTH_SHORT).show();
					wifiHandler
			...
			if (intent.getAction().equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
				...
				if (networkInfo != null
					...
					if (!ssid.equals(WifiAdmin.wifiSSID)) {
						...
						Toast.makeText(SocketClient_20150305_2.this, "WIFI连接成功",
								Toast.LENGTH_SHORT).show();
						Log.i(TAG, "WIFI连接成功");
						// WIFI连接后，连接服务器
					...
					Toast.makeText(SocketClient_20150305_2.this, "WIFI连接断开",
							Toast.LENGTH_SHORT).show();
					Log.i(TAG, "WIFI连接断开");
					closeSocket();
					closeIn();
	...
	private class SendHeartPackage extends Thread{
		public void run() {
			while(isConnectedServer) {
				...
				SocketClient_20150305_2.write(param);
				try {
					Thread.sleep(60000);
				} catch (InterruptedException e) {
					e.printStackTrace();
